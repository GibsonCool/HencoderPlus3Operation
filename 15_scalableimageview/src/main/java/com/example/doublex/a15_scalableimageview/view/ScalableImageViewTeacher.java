...
public class ScalableImageViewTeacher extends View implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener, Runnable {
    private static final float IMAGE_WIDTH = Utils.INSTANCE.dp2px(300);
    ...
    public ScalableImageViewTeacher(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
